...
<h3>Цель работы: Изучение основных операций c векторами и матрицами в системе MATLAB</h3>.
2.1 Основные положения
При вводе <p> значения векторов и матриц перечисляются в квадратных скобках. </p> Для разделения столбцов используются пробелы, для разделения строк – знак «;». Система MATLAB дает возможность ввода вектора, значения которого являются арифметической прогрессией:
